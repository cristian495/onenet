<div class="row">
    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
        <h3>Editar usuario <strong> {{$user_client->name}}</strong></h3>
    </div>
</div>
...
<form  id="f_editar_user_client"  method="post"  action="acceso/usuarios/editar_user_client" class="formentrada" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <input type="text" readonly class="form-control" value="{{$user_client->nombre_apellido}}"/>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <input type="text" readonly required value="{{$user_client->dni}}"  class="form-control" />
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <input type="text" readonly class="form-control" value="{{ $user_client->telefono }}"/>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <input type="text" readonly value="{{ $user_client->direccion }}"  class="form-control"/>
    ...
    <fieldset class="scheduler-border">
        ...
        <div class="row">
            <input type="hidden" value="{{$user_client->idcliente}}" name="iduser"/>
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12" >
                <div class="form-group">
                    <label for="precio">Usuario<span class="obligatorio">*</span></label>
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <input type="text" required value="{{$user_client->name}}" name="nombre_de_usuario" id="name_user" class="form-control" placeholder="Usuario..." />
                        <div style="cursor: pointer" class="input-group-addon"><span class="fa fa-user"></span></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12" >
                <div class="form-group">
                    ...
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <input type="text"  value="{{$user_client->email}}" name="email_de_usuario" id="email_user" class="form-control" placeholder="ejemplo@gmail.com..." />
