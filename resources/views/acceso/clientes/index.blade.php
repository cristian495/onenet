<input type="hidden" id="where_i_am" value="section_usuarios_cliente"/>
<div class="box box-primary">
    <div class="box-header">
        <div class="row col-md-3" style="margin-top: 6px">
            <h3 class="box-title">Listado usuarios clientes</h3>
        </div>
    </div>
    <div class="box-body">
        <div  class=" dataTables_wrapper form-inline dt-bootstrap">
            ...
            <table id="usuarios_cliente" style="width: 100%" class="table-responsive table table-hover table-bordered">
                <thead>
                <tr>
                    <th>Id</th>
                    <th>Cliente</th>
...
<script type="text/javascript">
    ...
    function cargar_tabla_usuarios_cliente(){
            oTable = $('#usuarios_cliente').DataTable({
            ...
            "ajax": {
                "url":"{{ route('datatables.usuarios_cliente') }}",
                "type":"post"
            },
            "order": [[ 0, "desc" ]],
            "columns": [
                ...
                { data: null,
                  render: function ( data, type, row) {
                    return"<a onclick='cargar_formulario(\"form_editar_userclient\","+ data.id +")' class='btn btn-xs btn-primary' >" +
