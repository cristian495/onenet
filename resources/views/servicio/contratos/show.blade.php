<div class="row">
    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
        <h3>Ver Contrato N°: <b>{{$contrato->id.' - '.$contrato->nombre_apellido}}</b></h3>
    ...
    <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                    <div class="cont_fecha_desc">
                        <input  disabled type="text" value="{{$contrato->fecha_pago}}" class="form-control" id="fecha_pago"/><span class="desc">De cada mes</span>
                    </div>
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                    <div class="cont_fecha_desc">
                        <input  readonly type="text" value="{{$contrato->fecha_corte}}" class="form-control" /><span class="desc">De cada mes</span>
                    </div>
                    <div style="cursor: pointer" class="input-group-addon"><span class="fa fa-calendar"></span></div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
            <div class="my_checkbox">
                <div class="checkbox">
                    <input checked type="checkbox"  disabled id="checkbox_torre">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input readonly type="text" class="form-control" value="{{$contrato->antena_essid}}" />
            </div>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                <label for="mac_antena">MAC <span class="obligatorio ">*</span></label>
                <input readonly type="text" class="form-control" value="{{$contrato->antena_mac}}" />
            </div>
        </div>
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input readonly type="text" class="form-control" value="{{$contrato->antena_ip}}" />
            </div>
        </div>
        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
            <div class="my_checkbox">
                <div class="checkbox">
                    <input checked type="checkbox"  disabled id="checkbox_ap">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="text"  readonly value="{{$contrato->marca_ap}}" class="form-control"/>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="text" readonly  value="{{$contrato->modelo_ap}}" class="form-control"/>
            </div>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                <label for="marca">Serie</label>
                <input type="text"  readonly value="{{$contrato->serie_ap}}" class="form-control"/>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
            <div class="my_checkbox">
                <div class="checkbox">
                    <input checked type="checkbox" disabled id="checkbox_router">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                <label for="marca">Marca</label>
                <input type="text"     readonly value="{{$contrato->marca_router}}" class="form-control"/>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                <label for="modelo">Modelo</label>
                <input type="text"    readonly value="{{$contrato->modelo_router}}" class="form-control"/>
            </div>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                <label for="marca">Serie</label>
                <input type="text"    readonly value="{{$contrato->serie_router}}" class="form-control"/>
            </div>
        </div>
